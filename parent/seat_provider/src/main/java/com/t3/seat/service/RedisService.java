...
public class RedisService<T> {
    ...
    public boolean putIfNotExits (String key,String val) {
        return stringRedisTemplate.opsForValue().setIfAbsent(key,val);
    }
    public boolean putIfNotExitsTime (String key,String val,long time) {
        return stringRedisTemplate.opsForValue().setIfAbsent(key,val, Duration.ofMillis(time));
    }
